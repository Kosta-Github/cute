...
namespace cute {
    ...
    struct test_suite_result {
        ...
        inline test_suite_result(
            std::size_t const test_cases_,
            std::size_t const test_cases_passed_,
            std::size_t const test_cases_failed_,
            std::size_t const test_cases_skipped_,
            std::size_t const checks_performed_,
            std::size_t const duration_ms_
        ) :
